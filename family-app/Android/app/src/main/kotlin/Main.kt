...
internal val logger: SkipLogger = SkipLogger(subsystem = "family.app", category = "FamilyApp")

private typealias AppRootView = FamilyAppRootView
private typealias AppDelegate = FamilyAppAppDelegate
